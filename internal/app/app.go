...
import (
	...
	"github.com/creafly/storage/internal/tracing"
...
func (a *App) initHttpRouting(r *gin.Engine) {
	...
	auth := api.Group("")
	auth.Use(middleware.AuthMiddleware(identityClient))
	auth.Use(middleware.TenantValidatorMiddleware(identityClient))
	{
