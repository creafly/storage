...
type FileServiceInterface interface {
	...
	GetByTenantID(ctx context.Context, tenantID uuid.UUID, fileType *entity.FileType, limit, offset int) (*entity.FileList, error)
...
func (m *MockFileService) GetByTenantID(ctx context.Context, tenantID uuid.UUID, fileType *entity.FileType, limit, offset int) (*entity.FileList, error) {
...
func (h *TestableFileHandler) List(c *gin.Context) {
	...
	fileList, err := h.fileService.GetByTenantID(c.Request.Context(), tenantID.(uuid.UUID), fileType, limit, offset)
	if err != nil {
...
func TestTestableFileHandler_List(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		mockSvc.On("GetByTenantID", mock.Anything, tenantID, (*entity.FileType)(nil), 20, 0).Return(fileList, nil)
