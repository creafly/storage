...
type FileServiceInterface interface {
	...
	GetByTenantID(ctx context.Context, tenantID uuid.UUID, fileType *entity.FileType, limit, offset int, includeAll bool) (*entity.FileList, error)
...
func (m *MockFileService) GetByTenantID(ctx context.Context, tenantID uuid.UUID, fileType *entity.FileType, limit, offset int, includeAll bool) (*entity.FileList, error) {
	args := m.Called(ctx, tenantID, fileType, limit, offset, includeAll)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
	return args.Get(0).(*entity.FileList), args.Error(1)
}
...
func (h *TestableFileHandler) List(c *gin.Context) {
	...
	fileList, err := h.fileService.GetByTenantID(c.Request.Context(), tenantID.(uuid.UUID), fileType, limit, offset, false)
	if err != nil {
...
func TestTestableFileHandler_List(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		mockSvc.On("GetByTenantID", mock.Anything, tenantID, (*entity.FileType)(nil), 20, 0, false).Return(fileList, nil)
